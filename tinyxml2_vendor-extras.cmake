...
if(TinyXML2_FOUND AND NOT TARGET tinyxml2::tinyxml2)
  ...
  if(NOT DEFINED TINYXML2_LIBRARY)
    ...
    elseif(DEFINED TinyXML2_LIBRARIES)
      ...
      message(FATAL_ERROR "None of TINYXML2_LIBRARY/TinyXML2_LIBRARY/TinyXML2_LIBRARIES variable is not defined")
    endif()
  endif()
  if(NOT DEFINED TINYXML2_INCLUDE_DIR)
    ...
    elseif(DEFINED TinyXML2_INCLUDE_DIRS)
      ...
      message(FATAL_ERROR "None of TINYXML2_INCLUDE_DIR/TinyXML2_INCLUDE_DIR/TinyXML2_INCLUDE_DIRS variable is not defined")
    endif()
  endif()
